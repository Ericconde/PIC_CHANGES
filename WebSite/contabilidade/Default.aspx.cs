...
public partial class contabilidade_Default : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (!usuarioCTL.PermitirAcesso(false, false, false, false, true, false, false, false, false, sIP, sPagina)) Response.Redirect("../login/logout.aspx");
        }
    ...
    private void CarregarEventosEdicao()
    {
        ...
        evento.CarregarDropDownListEventosEdicao(dropEdicao, true, false);
    }
