<%@ Page Title="PIC" Language="C#" MasterPageFile="~/controls/Admin.master" AutoEventWireup="true"
    CodeFile="Default.aspx.cs" Inherits="administrador_Default" %>
    ...
    <div class="box_home" style="width: 975px; ">
        ...
        <div class="texto_box_home_site">
            ...
            <div class="label">
                ...
                <asp:Button ID="cmdAtualizar" runat="server" CssClass="botao" TabIndex="2" Text="Atualizar" OnClick="cmdAtualizar_Click" />
            </div>
