...
public partial class administrador_relatorios : App_Code.BaseWeb
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (!usuarioCTL.PermitirAcesso(true, true, false, false, true, false, false, false, false, sIP, sPagina)) Response.Redirect("../login/logout.aspx");
        }
    }
