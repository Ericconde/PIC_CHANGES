<%@ Page Title="PIC" Language="C#" MasterPageFile="~/controls/Admin.master" AutoEventWireup="true"
    CodeFile="vouchersBaixados.aspx.cs" Inherits="relatorios_vouchersBaixados" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <ContentTemplate>
            ...
            <div class="box_home">
                <h1> RELATÓRIO - VOUCHERS A BAIXAR</h1>
                            ...
                            <td>
                                <table class="style4">
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        <td class="celula_nome_campo">
                                            <asp:Label  ID="lblStatus" runat="server" CssClass="label" Text="Status do Voucher:"></asp:Label>
                                        </td>
                                        <td class="celula_campo">
                                            <asp:DropDownList ID="dropStatusVoucher" runat="server" CssClass="dropdown" Width="300px">
                                                <asp:ListItem Selected="True" Value="1">SELECIONE...</asp:ListItem>
                                                <asp:ListItem Selected="false" Value="2">Baixado</asp:ListItem>
                                                <asp:ListItem Selected="false" Value="3">Não Baixado</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="celula_nome_campo">
                                                        <asp:Label  ID="Label1" runat="server" CssClass="label" Height="16px" 
                                                            Text="Dígito:" Width="45px"></asp:Label>
                                                    </td>
                                                    <td class="celula_campo" width="100%">
                            ...
                            <td valign="top">
                                <asp:GridView ID="grdRelatorio" runat="server" CssClass="grid" 
                                    ...
                                    <Columns>                                        
                                        ...
                                        <asp:BoundField DataField="Data da Entrega" HeaderText="Data da Entrega" />
                                        <asp:BoundField DataField="Responsável pela entrega" HeaderText="Responsável pela entrega" />                                          
                                    </Columns>
