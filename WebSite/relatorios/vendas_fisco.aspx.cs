...
public partial class relatorios_vendas_fisco : System.Web.UI.Page
{
    ...
    protected void grdVenda_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        grdVenda.PageIndex = e.NewPageIndex;
        CarregarRelatorio();
    }
    ...
    private DataTable CarregarRelatorio()
    {
        ...
        try
        {
            ...
            dataTable = CRelatorio.RetornarVendasFisco(sDataInicial, sDataFinal, iIDEdicao); 
    ...
    {    
            ...
            ExportarExcel(dataTable, "VendasFisco");        
    }
    ...
    protected void grdVenda_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            if (e.Row.Cells[7].Text == "Sim")
            {
                e.Row.Cells[8].Text = String.Format("{0:0,0.00}", Convert.ToDouble(e.Row.Cells[8].Text));
                ...
                string sIDVenda = Criptografia.Criptografar(grdVenda.DataKeys[e.Row.RowIndex].Values[0].ToString(), sChave, sVetorInicializacao);
