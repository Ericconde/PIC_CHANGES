<%@ Page Title="PIC" Language="C#" MasterPageFile="~/controls/Admin.master"
    AutoEventWireup="true" CodeFile="vendasDetalhado.aspx.cs" Inherits="relatorios_vendasDetalhado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <ContentTemplate>
            ...
            <div class="box_home">
                <h1>RELATÓRIO - VENDAS DETALHADO</h1>
                            ...
                            <td>
                                <table class="style4">
                                    ...
                                    <tr>
                                        ...
                                        <td class="celula_campo">
                                            <cc2:CustomTextBox ID="txtNumCota" runat="server" CssClass="textbox" MaxLength="6" onkeydown="mascara(this,soNumeros)" onkeypress="mascara(this,soNumeros)" onkeyup="mascara(this,soNumeros)" TabIndex="4" Width="120px"></cc2:CustomTextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="style9" colspan="2">
                                            ...
                                            &nbsp;<asp:Button ID="cmdExportarExcel" runat="server" CssClass="botao" OnClick="cmdExportarExcel_Click" TabIndex="2" Text="Exportar Excel" />
