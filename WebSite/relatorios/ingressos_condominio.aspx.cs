...
public partial class relatorios_ingressos_condominio : System.Web.UI.Page
{
    ...
    private DataTable CarregarRelatorio(int iExportando)
    {
        ...
        try
        {
            ...
            dataTable = CRelatorio.RetornarVendasCondominio(iIDEdicao, sDataInicial, sDataFinal, iExportando);
    ...
    {
        DataTable dataTable = CarregarRelatorio(1);
        ExportarExcel(dataTable, "VendasCondominio");
    }
