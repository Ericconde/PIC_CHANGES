...
public partial class relatorios_vendaNaoAprovada : System.Web.UI.Page
{
    ...
    protected void grdVendaNaoAprovada_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        grdVendaNaoAprovada.PageIndex = e.NewPageIndex;
        CarregarRelatorio();
    }
    ...
    private DataTable CarregarRelatorio()
    {
        ...
        try
        {
            ...
            string sPrimeiroDiaMes = PontoBr.Conversoes.Data.ConverterDataFormatoDDMMAAAAComBarraParaAAAAMMDDComBarra(primeiroDia.ToString());
            string sUltimoDiaMes = PontoBr.Conversoes.Data.ConverterDataFormatoDDMMAAAAComBarraParaAAAAMMDDComBarra(ultimoDia.ToString());

            string sDataInicial = txtDataInicial.Text.Trim() == "" ? sPrimeiroDiaMes : PontoBr.Conversoes.Data.ConverterDataDMMAAAAComBarraParaFormatoBancoAAAAMMDD(txtDataInicial.Text);
            string sDataFinal = txtDataFinal.Text.Trim() == "" ? sUltimoDiaMes : PontoBr.Conversoes.Data.ConverterDataDMMAAAAComBarraParaFormatoBancoAAAAMMDD(txtDataFinal.Text) + " 23:59:59";
            ...
            dataTable = CRelatorio.RetornarVendaNaoAprovadaCartao(sDataInicial, sDataFinal, iIDEdicao, sIDPerfil, iIDVenda);

            grdVendaNaoAprovada.DataSource = dataTable;
            grdVendaNaoAprovada.DataBind();
    ...
    {    
            ...
            ExportarExcel(dataTable, "VendaNaoAprovada");        
    }
