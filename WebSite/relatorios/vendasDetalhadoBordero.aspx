<%@ Page Title="" Language="C#" MasterPageFile="~/controls/Fisco.master" AutoEventWireup="true" CodeFile="vendasDetalhadoBordero.aspx.cs" Inherits="relatorios_vendasDetalhadoBordero" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  ...
  <Triggers>
        ...
        <ContentTemplate>
            ...
            <div class="box_home">
                <h1>RELATÓRIO - VENDA DETALHADO</h1>
                <div class="texto_box_home_site">
                    ...
                    <asp:GridView ID="grdVendaDetalhadoBordero" runat="server" AllowPaging="True" 
                                    AutoGenerateColumns="False" CssClass="grid" 
                                    EmptyDataText="Não existe registro para esse intervalo de data!" 
                                    onpageindexchanging="grdVendaDetalhadoBordero_PageIndexChanging" PageSize="25" 
                                    Width="124%">
                                    <RowStyle CssClass="grid" HorizontalAlign="left" />
                                    <Columns>
                                        <asp:BoundField DataField="Número Ingresso" HeaderText="Número Ingresso" />
                                        <asp:BoundField DataField="Tipo" HeaderText="Tipo" />
                                        <asp:BoundField DataField="Data/Hora Compra" HeaderText="Data/Hora Compra" />
                                        <asp:BoundField DataField="FormaPagamento" HeaderText="FormaPagamento" />
                                    </Columns>
