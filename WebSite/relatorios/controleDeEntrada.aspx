<%@ Page Title="" Language="C#" MasterPageFile="~/controls/Fisco.master" AutoEventWireup="true" CodeFile="controleDeEntrada.aspx.cs" Inherits="relatorios_controleDeEntrada" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  ...
  <Triggers>
        ...
        <ContentTemplate>
            ...
            <div class="box_home">
                <h1>RELATÓRIO - CONTROLE DE ENTRADA</h1>
                <div class="texto_box_home_site">
                    ...
                    <asp:GridView ID="grdControleEntrada" runat="server" AllowPaging="True" 
                                    AutoGenerateColumns="False" CssClass="grid" 
                                    EmptyDataText="Não existe registro para esse intervalo de data!" 
                                    onpageindexchanging="grdControleEntrada_PageIndexChanging" PageSize="25" 
                                    Width="124%">
                                    <RowStyle CssClass="grid" HorizontalAlign="left" />
                                    <Columns>
                                        <asp:BoundField DataField="Número do ingresso" HeaderText="Número do ingresso" />
                                        <asp:BoundField DataField="tipo de ingresso" HeaderText="Tipo" />
