...
public partial class relatorios_compradosSaldo : App_Code.BaseWeb
{
    ...
    private void CarregarRelatorio()
    {
        try
        {
            ...
            DataTable dataTable = CRelatorio.RetornarCompradosSaldo(sDataInicial, sDataFinal, iIDEdicao, iLote, sIDPerfil, iIDFormaPagamento);

            reportDocument = new ReportDocument();
            reportDocument.Load(Server.MapPath("~/relatorios/compradoSaldo.rpt"));
