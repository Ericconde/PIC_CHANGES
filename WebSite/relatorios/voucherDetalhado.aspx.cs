...
public partial class relatorios_voucherDetalhado : App_Code.BaseWeb
{
    ...
    private void CarregarRelatorio()
    {
        try
        {
            ...
            DataTable dataTable = CRelatorio.RetornarVoucherDetalhado(iIDVenda, sDataInicial, sDataFinal, iIDEdicao, iLote, sIDPerfil, iIDFormaPagamento);
