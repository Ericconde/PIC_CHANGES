...
public partial class relatorios_resumoPagamento : App_Code.BaseWeb
{
    ...
    private void CarregarRelatorio()
    {
        try
        {
            ...
            DataTable dataTable = CRelatorio.RetornarResumoFormaPagamento(sDataInicial, sDataFinal, iIDEdicao, iLote, sIDPerfil, iIDFormaPagamento);

            reportDocument = new ReportDocument();
            reportDocument.Load(Server.MapPath("~/relatorios/resumoPagamento.rpt"));
