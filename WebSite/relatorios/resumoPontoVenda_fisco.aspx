...
CodeFile="resumoPontoVenda_fisco.aspx.cs" Inherits="relatorios_resumoPontoVenda_fisco" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  ...
  <Triggers>
        ...
        <ContentTemplate>
            ...
            <div class="box_home">
                <h1>RELATÓRIO - RESUMO POR PONTO DE VENDA FISCO</h1>
                <div class="texto_box_home_site">
                    ...
                    <asp:GridView ID="grdVendaSintetico" runat="server" AllowPaging="True" 
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="Ponto de Venda" HeaderText="Ponto de Venda" />
                                        <asp:BoundField DataField="Quantidade Vendida" HeaderText="Quantidade vendida" />
