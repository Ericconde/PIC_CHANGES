<%@ Page Title="" Language="C#" MasterPageFile="~/controls/Fisco.master" AutoEventWireup="true" CodeFile="vendasSinteticoBordero.aspx.cs" Inherits="relatorios_vendasSinteticoBordero" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  ...
  <Triggers>
        ...
        <ContentTemplate>
            ...
            <div class="box_home">
                <h1>RELATÓRIO - VENDA SINTÉTICO</h1>
                <div class="texto_box_home_site">
                    ...
                    <asp:GridView ID="grdVendaSintetico" runat="server" AllowPaging="True" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Quantidade" HeaderText="Quantidade vendida" />
