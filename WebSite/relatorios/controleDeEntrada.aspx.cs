...
public partial class relatorios_controleDeEntrada : System.Web.UI.Page
{
    ...
    protected void grdControleEntrada_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        grdControleEntrada.PageIndex = e.NewPageIndex;
        CarregarRelatorio();
    }
    ...
    private DataTable CarregarRelatorio()
    {
        ...
        try
        {
            ...
            dataTable = CRelatorio.RetornarControleEntradaBordero(sDataInicial, sDataFinal, iIDEdicao);

            grdControleEntrada.DataSource = dataTable;
            grdControleEntrada.DataBind();
    ...
    {    
            ...
            ExportarExcel(dataTable, "ControleEntradaBordero");        
    }
