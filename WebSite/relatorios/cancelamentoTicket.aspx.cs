...
public partial class relatorios_cancelamentoTicket : System.Web.UI.Page
{
    ...
    private DataTable CarregarRelatorio()
    {
        ...
        try
        {
            ...
            dataTable = CRelatorio.RetornarCancelamentosTicket(sDataInicial, sDataFinal, iIDEdicao, iIDFormaPagamento, dNumeroCota, sDigito);
    ...
    protected void cmdExportarExcel_Click(object sender, EventArgs e)
    {
        ...
        ExportarExcel(dataTable, "CancelamentosTicket");
    }
