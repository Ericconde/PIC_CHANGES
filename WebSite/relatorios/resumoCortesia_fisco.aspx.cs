...
public partial class relatorios_resumoCortesia_fisco : System.Web.UI.Page
{
    ...
    private DataTable CarregarRelatorio()
    {
        ...
        try
        {
            ...
            dataTable = CRelatorio.RetornarResumoCortesiaFisco(sDataInicial, sDataFinal, iIDEdicao);
    ...
    {    
            ...
            ExportarExcel(dataTable, "VendaSinteticoBordero");        
    }
    ...
    protected void grdVendaSintetico_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            e.Row.Cells[5].Text = String.Format("{0:0,0.00}", Convert.ToDouble(e.Row.Cells[5].Text));
