...
public partial class relatorios_dadosEvento : System.Web.UI.Page
{
    ...
    protected void grdDadosEventos_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        grdDadosEventos.PageIndex = e.NewPageIndex;
        CarregarRelatorio();
    }
    ...
    private DataTable CarregarRelatorio()
    {
        ...
        try
        {
            ...
            dataTable = CRelatorio.RetornarDadosEventoBordero(sDataInicial, sDataFinal, iIDEdicao);


            dataTable.Columns.Remove("IDLote");
            dataTable.Columns.Remove("IDEdicao");
            dataTable.Columns.Remove("IngressosAvulsos");
            dataTable.Columns.Remove("IngressosCadeiras");
            dataTable.Columns.Remove("Edicao");

            grdDadosEventos.DataSource = dataTable;
            grdDadosEventos.DataBind();
    ...
    protected void cmdExportarExcel_Click(object sender, EventArgs e)
    {
        ...
        ExportarExcel(dataTable, "DadosDoEventoBordero");
    }
