...
public partial class relatorios_resumoPontoVenda_fisco : System.Web.UI.Page
{
    ...
    private DataTable CarregarRelatorio()
    {
        ...
        try
        {
            ...
            dataTable = CRelatorio.RetornarResumoPontoVendaFisco(sDataInicial, sDataFinal, iIDEdicao);
    ...
    {    
            ...
            ExportarExcel(dataTable, "ResumoPontoVendaFisco");        
    }
