...
CodeFile="vendas_fisco.aspx.cs" Inherits="relatorios_vendas_fisco" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  ...
  <Triggers>
        ...
        <ContentTemplate>
            ...
            <div class="box_home">
                <h1>RELATÓRIO - VENDAS FISCO (EFETIVADAS OU NÃO)</h1>
                <div class="texto_box_home_site">
                    ...
                    <asp:GridView ID="grdVenda" runat="server" AllowPaging="True" 
                                    AutoGenerateColumns="True" CssClass="grid" DataKeyNames="Voucher"
                                    EmptyDataText="Não existe registro para esse intervalo!" 
                                    onpageindexchanging="grdVenda_PageIndexChanging" PageSize="25" 
                                    Width="124%" onrowdatabound="grdVenda_RowDataBound">
