...
public partial class relatorios_vendasSinteticoBordero : System.Web.UI.Page
{
    ...
    private DataTable CarregarRelatorio()
    {
        ...
        try
        {
            ...
            dataTable = CRelatorio.RetornarVendasSinteticoBordero(sDataInicial, sDataFinal, iIDEdicao);
