...
public partial class relatorios_recibosPendentes : System.Web.UI.Page
{
    ...
    private DataTable CarregarRelatorio()
    {
        ...
        try
        {
            ...
            dataTable = CRelatorio.RetornarRecibosPendentes(sDataInicial, sDataFinal, iIDEdicao, iIDFormaPagamento, dNumeroCota, sDigito);
    ...
    protected void cmdExportarExcel_Click(object sender, EventArgs e)
    {
        ...
        ExportarExcel(dataTable, "RecibosPendentes");
    }
