<%@ Page Title="PIC" Language="C#" MasterPageFile="~/controls/Admin.master" AutoEventWireup="true"
    CodeFile="recibosPendentes.aspx.cs" Inherits="relatorios_recibosPendentes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <ContentTemplate>
            ...
            <div class="box_home">
                <h1>
                    RELATÓRIO - RECIBOS PENDENTES</h1>
                                    ...
                                    <td valign="top">
                                        <asp:GridView ID="grdRelatorio" runat="server" CssClass="grid" AllowPaging="True"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Nome do vendedor" HeaderText="Nome do Vendedor" />
                                            </Columns>
