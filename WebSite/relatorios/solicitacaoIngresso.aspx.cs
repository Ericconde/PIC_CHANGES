...
public partial class relatorios_solicitacaoIngresso : System.Web.UI.Page
{
    ...
    private DataTable CarregarRelatorio()
    {
        ...
        try
        {
            ...
            dataTable = CRelatorio.RetornarSolicitacoesIngressos(iIDEdicao);
    ...
    protected void cmdExportarExcel_Click(object sender, EventArgs e)
    {
        ...
        ExportarExcel(dataTable, "SolicitacaoIngresso");
    }
