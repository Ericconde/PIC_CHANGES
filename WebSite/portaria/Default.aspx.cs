...
public partial class portaria_Default : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (!usuarioCTL.PermitirAcesso(false, false, false, false, false, false, false, true, false, sIP, sPagina)) Response.Redirect("../login/logout.aspx");
        }
    ...
    private void CarregarEventosEdicao()
    {
        ...
        evento.CarregarDropDownListEventosEdicaoVenda(dropEdicao, true, false);
    }
