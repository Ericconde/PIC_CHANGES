<%@ Page Title="PIC" Language="C#" MasterPageFile="~/controls/Financeiro.master" AutoEventWireup="true"
    CodeFile="relatorios.aspx.cs" Inherits="financeiro_relatorios" %>
            ...
            <div class="texto_box_home_candidato">
                ...
                <asp:HyperLink ID="HyperLink9" runat="server" NavigateUrl="~/relatorios/pagamentoCartao.aspx"
                 ...
                 <asp:HyperLink ID="HyperLink10" runat="server" NavigateUrl="~/relatorios/cancelamentoVoucher.aspx"
                    ...
                    <asp:HyperLink ID="HyperLink16" runat="server" NavigateUrl="~/relatorios/ingressos.aspx"
                    CssClass="link_relatorio">16 - Impressão de Ingressos</asp:HyperLink>

                    <asp:HyperLink ID="HyperLink17" runat="server" NavigateUrl="~/relatorios/cancelamentoTicket.aspx"
                    CssClass="link_relatorio">17 - Cancelamentos Ticket/Ingresso</asp:HyperLink>

                    <asp:HyperLink ID="HyperLink18" runat="server" NavigateUrl="~/relatorios/solicitacaoIngresso.aspx"
                    CssClass="link_relatorio">18 - Solicitações de Ingressos (por e-mail)</asp:HyperLink>

                    <asp:HyperLink ID="HyperLink19" runat="server" NavigateUrl="~/relatorios/alteracaoEmail.aspx"
                    CssClass="link_relatorio">19 - Alterações de E-mail</asp:HyperLink>

                    <asp:HyperLink ID="HyperLink20" runat="server" NavigateUrl="~/relatorios/retornoCatraca_app.aspx"
                    CssClass="link_relatorio">20 - Registro de Entrada (App leitor de QRCode)</asp:HyperLink>

                <asp:HyperLink ID="HyperLink14" runat="server" NavigateUrl="~/relatorios/retornoCatraca_fisica.aspx"
                    CssClass="link_relatorio">21 - Registro de Entrada (catraca física)</asp:HyperLink>
            </div>
        </div>
    </div>
    <div class="clear">
