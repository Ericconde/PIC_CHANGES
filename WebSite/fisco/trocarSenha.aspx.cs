...
public partial class fisco_trocarSenha : App_Code.BaseWeb
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (!usuarioCTL.PermitirAcesso(true, false, false, false, false, false, false, false, true, sIP, sPagina)) Response.Redirect("../login/logout.aspx");
        }
