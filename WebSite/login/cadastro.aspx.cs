...
public partial class cadastro_usuario : App_Code.BaseWeb
{
    ...
    protected void cmdNovo_Click(object sender, EventArgs e)
    {
        try
        {
            if (PodeSalvar())
            {
                ...
                LimparFormulario();
                ExibirMensagemPopUpPositivo("Cliente cadastrado com sucesso!");

            }
        }
        catch (Exception ex)
        {
            ExibirMensagemPopUpNegativo("Erro: " + ex.Message);
        }
    }
    ...
    private void LimparFormulario()
    {
        ...
        ExibirMensagemPopUpPositivo("Cadastro cancelado!");
    }
}
