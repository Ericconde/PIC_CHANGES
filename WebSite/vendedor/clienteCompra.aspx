<%@ Page Title="PIC" Language="C#" MasterPageFile="~/controls/Vendedor.master"
    AutoEventWireup="true" CodeFile="clienteCompra.aspx.cs" Inherits="vendedor_clienteCompra" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="box_home">
                <h1>Compra - Selecionar Cliente</h1>
                    ...
                    <table style="margin-top: 5px;">
                        ...
                        <tr>
                            <td class="style7" valign="top">
                                <asp:GridView ID="grdCliente" runat="server" CssClass="grid"  
                                    DataKeyNames="IDUsuario,Debito,Núm. Cota" Width="127%" AutoGenerateColumns="False" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:ButtonField CommandName="Selecionar" DataTextField="Email" HeaderText="E-mail" HeaderStyle-BackColor="#4d94c4"/>
                                        <asp:ButtonField CommandName="Selecionar" DataTextField="Perfil" HeaderText="Perfil" HeaderStyle-BackColor="#4d94c4"/>
                                        <asp:ButtonField CommandName="Selecionar" DataTextField="Núm. Cota" HeaderText="Núm. Cota" HeaderStyle-BackColor="#4d94c4"/>
                                        <asp:ButtonField CommandName="Selecionar" DataTextField="Data Cadastro" HeaderText="Data Cadastro" HeaderStyle-BackColor="#4d94c4"/>                                        
                                    </Columns>
