<%@ Page Language="C#" AutoEventWireup="true" Title="PIC" CodeFile="IngressosBoate.aspx.cs"
                    ...
                    <table id="TabelaIngresso" style='border: 1px; border-color: Gray; border-style: solid;
                        ...
                        <tr id="Linha_Informaçao">
                            <td id="td_Informacoes" valign="top" style="border-right-width: thin; border-right-color: black;
                                ...
                                <asp:Label  ID="lblTipoIngressoTitulo" runat="server" Verticalalign="top" Text='<%# DataBinder.Eval(Container.DataItem, "TipoIngressoTitulo") %>' style="font-size: 14px; padding-left: 110px;"></asp:Label>
                            ...
                            <td id="Orientação" valign="top" style="width: 310px; min-width: 310px; max-width: 310px;">
                                ...
                                <ul type="disc" style=" margin-bottom: 0px; padding-left: 30px; font-size: 10px;
                                    ...
                                    <li style="margin-bottom: 0px;"><b>Importante:</b> Não faça cópias desse ingresso. Ele
                                        ...
                                        leitores terá acesso ao evento. </li><br />
