    ...
    private DataTable RetornarColunasDescricao(DataTable dataTable)
    {
        ...
        foreach (DataRow dataRow in dataTable.Rows)
        {
            ...
            if (dataRow["Evento"].ToString() == "Boate")
            {
                ...
                if (dataRow["TipoIngressoTitulo"].ToString() == "Sócio cadeira" || dataRow["TipoIngressoTitulo"].ToString() == "Sócio avulso" || dataRow["TipoIngressoTitulo"].ToString() == "Cortesia sócio Aniversariante" || dataRow["TipoIngressoTitulo"].ToString() == "Venda presencial Sócio")
                {
                    dataRow["TipoIngressoTitulo"] = "SÓCIO";
                }

                if (dataRow["TipoIngressoTitulo"].ToString() == "Não sócio cadeira" || dataRow["TipoIngressoTitulo"].ToString() == "Não sócio avulso" || dataRow["TipoIngressoTitulo"].ToString() == "Cortesia não sócio Aniversariante" || dataRow["TipoIngressoTitulo"].ToString() == "Venda presencial Não sócio")
                {
