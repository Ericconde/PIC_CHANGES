<%@ Page Language="C#" AutoEventWireup="true" Title="PIC" CodeFile="Ingressos.aspx.cs"
    Inherits="cliente_Ingressos" EnableEventValidation="false" %>
                        ...
                        <tr id="Linha_Informaçao">
                            <td id="td_Informacoes" valign="top" style="border-right-width: thin; border-right-color: black;
                                ...
                                <div id="InformaçoesTicket" style="line-height: 1.9; font-size: 9px; padding-top: 8px;
                                    padding-left: 15px;">
                                    <b>
                                        <asp:Label  ID="Label6" runat="server" Text="EVENTO: " CssClass="Strong-Text"></asp:Label></b>
                                    <asp:Label  ID="Label7" runat="server" Verticalalign="top" style="font-size:12px; font-weight:bold" Text='<%# DataBinder.Eval(Container.DataItem, "Evento") %>'></asp:Label>
                                    <br />
                                    <b>
                                        <asp:Label  ID="Label8" runat="server" Text="EDIÇÃO: " CssClass="Strong-Text"></asp:Label></b>
                                    <asp:Label  ID="Label9" runat="server" Verticalalign="top" style="font-size:12px; font-weight:bold" Text='<%# DataBinder.Eval(Container.DataItem, "Edicao") %>'></asp:Label>
                                    <br />
                                    ...
                                    <b>
                                        <asp:Label  ID="LblTituloCPF" runat="server" Text="CPF: " style="padding-left:80px;" CssClass="Strong-Text"></asp:Label></b>
                                    ...
                                    <asp:Label  ID="Label1" runat="server" Text="(v3)" style="text-align:right; font-size:10px; padding-left:50px; "/>
                                    </p>
                                    <p>
                                        <b>
                            ...
                            <td id="Orientação" valign="top" style="width: 310px; min-width: 310px; max-width: 310px;">
                                ...
                                <ul type="disc" style=" margin-bottom: 0px; padding-left: 30px; font-size: 7px;
                                    page-break-inside: avoid; text-align: justify; min-width: 270px; max-width: 270px;
                                    width: 270px;">
                                    <li style="margin-bottom: 0px; color:red; font-weight:bold;">O PIC seguirá as normas de enfrentamento à Covid estabelecidas pela Prefeitura de Belo Horizonte e vigentes no dia da Festa Junina. Fique atento e acompanhe em nosso site e redes sociais as regras específicas para acesso ao evento.</li><br />
